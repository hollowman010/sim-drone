...
class DroneVisionLogger:
    ...
    def __init__(self, name: str, log_file: str = "drone_vision.log", level: str = "INFO"):
    ...
    def log_mission_event(self, event: str, position: Optional[tuple] = None, 
    ...
    def log_sensor_data(self, sensor_type: str, data: dict):
        ...
        Args:
            ...
            data: Sensor data
        """
        self.log_event("sensor", {
            "sensor_type": sensor_type,
            "data": data
        })
        
    def log_vision_result(self, objects_detected: list, obstacles: list, 
                         path_clearance: bool):
