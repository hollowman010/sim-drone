...
def demo_vision_processing():
    ...
    sensor_data = {
        ...
        "orientation": None,
        "velocity": None,
        "images": {"image_0": rgb_image, "image_1": depth_image, "image_2": seg_image},
        "gps": None,
        "collision": None,
    }
...
def demo_navigation():
    ...
    print(
        f"Current Waypoint: {status['current_patrol_index']}/{status['total_patrol_waypoints']}"
    )
...
def demo_mission_logic():
    ...
    patrol_waypoints = [(0, 0, 20), (50, 0, 20), (50, 50, 20), (0, 50, 20)]
    ...
    scenarios = [
        ...
        },
        {
            ...
            "vision_results": {
                "objects_detected": [
                    {"type": "target", "confidence": 0.9, "bbox": [100, 100, 50, 50]}
                ],
                "obstacles": [],
                "path_clearance": True,
            },
    ...
    for scenario in scenarios:
        ...
        commands = mission_logic.update(
            scenario["vision_results"], scenario["position"]
        )
